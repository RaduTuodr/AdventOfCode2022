...
const int CAVE_MAX2 = 9e2 + 1;
const int LINE_MAX = 3e2;

int max_i_coord,
max_j_coord;
int min_i_coord = CAVE_MAX2,
min_j_coord = CAVE_MAX2;
char cave[CAVE_MAX][CAVE_MAX2];
...
int main() {
	...
	read();
	cout << min_i_coord << " " << min_j_coord << endl;
	cout << max_i_coord << " " << max_j_coord << endl;
	solve();
	display();
